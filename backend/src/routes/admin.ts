...
router.post('/products', productUpload.fields([{ name: 'main_image', maxCount: 1 }, { name: 'secondary_images', maxCount: 10 }]) as any, createProduct);
router.put('/products/:id', productUpload.fields([{ name: 'main_image', maxCount: 1 }, { name: 'secondary_images', maxCount: 10 }]) as any, updateProduct);
...
router.put('/settings/logo', upload.single('logo') as any, updateSiteLogo);
router.put('/settings/home-display', updateHomeDisplay);

// Banners
router.get('/banners', getBanners);
router.post('/banners', upload.array('banners', 10) as any, uploadBanners); // Máximo 10 banners por vez
